...
define gui.idle_small_color = '#d50e78'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#09ec14'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#29ef0f'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#d50e78'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#d50e78'
define gui.hover_muted_color = '#d50e78'
...
define gui.main_menu_background = im.Scale("images/Screen/main_menu1.png",1280,720)
...
define gui.namebox_width = 160
define gui.namebox_height = gui.name_text_size + 15
...
define gui.choice_button_borders = Borders(120, 10, 120, 10)
